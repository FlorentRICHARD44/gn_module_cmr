...
export class SiteGroupDetailsComponent extends BaseMapViewComponent implements OnInit {
  ...
  /**
   * Switched on when opening the tab "individual"
   */
  showIndividuals() {
  ...
  /**
   * Switched on when opening the tab "site"
   */
  showSites() {
  ...
  /**
   * Button to open modal to create visits for selected sites.
   */
  onClickBatchVisit() {
  ...
  /**
   * Refresh the list of sites according filter.
   * @param event 
   */
  ...
  /**
   * Refresh the individual list according filters.
   * @param event 
   */
